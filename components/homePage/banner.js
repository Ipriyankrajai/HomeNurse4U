        ...
        <div className="max-w-[700px] m-auto absolute bottom-[50px] left-[158px]">
          ...
          >
            ...
            <p className="ml-[20px] text-[18px] leading-[150%] font-normal text-white mt-[10px] max-w-[700px]">
              An ISO 9001:2015 certified clinical trial company that provides
              the best care and support to patients while staying where they
              feel most comfortable, at their own home.
            </p>
          </div>
        </div>
      </div>
